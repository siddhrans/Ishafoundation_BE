...
`Update_Details_ID` int(11) NOT NULL AUTO_INCREMENT ,
 
 `Update_Phone_Num` varchar(45) NOT NULL,
 
 `Update_Name` varchar(45) NOT NULL,
 
 `Update_Email_id` varchar(45) NOT NULL,
 
 `Update_Amount` double NOT NULL,

`Update_Status` varchar(45) DEFAULT NULL,

`Update_Region` varchar(45) DEFAULT NULL,

`Update_State` varchar(45) DEFAULT NULL,

`Update_City` varchar(45) DEFAULT NULL,
 
`Update_Center` varchar(45) DEFAULT NULL,
 
`Update_Bank_Acct_Holder_Name` varchar(45) NOT NULL,

  `Update_Bank_Name` varchar(45) DEFAULT NULL,

 `Update_Bank_Branch` varchar(45) DEFAULT NULL,

`Update_Bank_Acct_Num` varchar(45) NOT NULL,

`Update_Bank_MICR` decimal(10,0) DEFAULT NULL,

`Update_Bank_IFSC_Cd` varchar(45) DEFAULT NULL,

`Update_Bank_Acct_Type` varchar(45) NOT NULL,

`Update_Donation_Start_Dt` date NOT NULL,

  `Update_Donation_End_Dt` date NOT NULL,

`Update_Donation_Frequency` varchar(45) NOT NULL,

`Update_TPPS_Consumer_Code` varchar(45) DEFAULT NULL,

`Update_Create_Dt` varchar(45) DEFAULT NULL,

`Update_Comments` varchar(500) DEFAULT NULL,

 

  PRIMARY KEY (`Update_Details_ID`),

  UNIQUE KEY `Update_Details_ID_UNIQUE` (`Update_Details_ID`)
