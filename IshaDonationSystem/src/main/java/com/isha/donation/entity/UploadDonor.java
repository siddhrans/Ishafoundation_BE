...
public class UploadDonor implements Serializable {
	...
	@Column(name = "Update_Details_ID", nullable = false)
	private Long id;

	@Column(name = "Update_Phone_Num", nullable = false)
	private String updatemobileNumber;
	
	@Column(name = "Update_Name", nullable = false)
	private String name;
	
	@Column(name = "Update_Email_id", nullable = false)
	private String email;
	

	@Column(name = "Update_Amount", nullable = false)
	...
	@Column(name = "Update_Center")
	private String center;
	
	

	@Column(name = "Update_Bank_Acct_Holder_Name", nullable = false)
	private String bankAccountholderName;
	

	@Column(name = "Update_Bank_Name")
	private String bankName;
	
	@Column(name = "Update_Bank_Branch")
	private String branchName;
	
	@Column(name = "Update_Bank_Acct_Num", nullable = false)
	private String bankAccountNumber;
	
	@Column(name = "Update_Bank_MICR")
	private int bankMICR;

	@Column(name = "Update_Bank_IFSC_Cd")
	private String bankIfscCode;
	
	
	@Column(name = "Update_Bank_Acct_Type", nullable = false)
	private String bankAccountType;
	
	@Temporal(TemporalType.DATE)
	@Column(name = "Update_Donation_Start_Dt", nullable = false)
	private Date startDate;
	
	@Temporal(TemporalType.DATE)
	@Column(name = "Update_Donation_End_Dt", nullable = false)
	private Date endDate;

	@Column(name = "Update_Donation_Frequency", nullable = false)
	private String frequency;

	@Column(name = "Update_TPPS_Consumer_Code")
	private String TPPSConsumerCode;
	
	
	@Column(name = "Update_Create_Dt")
	...
	public String toString() {
		return "UploadDonor [id=" + id + ", updatemobileNumber=" + updatemobileNumber + ", name=" + name + ", email="
				+ email + ", amount=" + amount + ", status=" + status + ", region=" + region + ", state=" + state
				+ ", city=" + city + ", center=" + center + ", bankAccountholderName=" + bankAccountholderName
				+ ", bankName=" + bankName + ", branchName=" + branchName + ", bankAccountNumber=" + bankAccountNumber
				+ ", bankMICR=" + bankMICR + ", bankIfscCode=" + bankIfscCode + ", bankAccountType=" + bankAccountType
				+ ", startDate=" + startDate + ", endDate=" + endDate + ", frequency=" + frequency
				+ ", TPPSConsumerCode=" + TPPSConsumerCode + ", createDate=" + createDate + ", comments=" + comments
				+ "]";
	}
